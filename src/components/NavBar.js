...
const NavBar = () => {
  ...
  return (
    <div>
      <header>
        <Navbar expanded={expanded} onToggle={(expanded) => setExpanded(expanded)} bg="dark" variant="dark" expand="lg">
          <Container className='text-center'>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="ms-auto">
                <NavLink onClick={handleNavLinkClick} className='nav-body nav-link' to="/">Home</NavLink>
                <NavLink onClick={handleNavLinkClick} className='nav-body nav-link' to="/about">About</NavLink>
